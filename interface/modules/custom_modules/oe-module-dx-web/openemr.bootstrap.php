...
*/
function oe_module_dxweb_settings_add_menu_item(MenuEvent $event)
{
    $menu = $event->getMenu();
...
$eventDispatcher->addListener(MenuEvent::MENU_UPDATE, 'oe_module_dxweb_settings_add_menu_item');
